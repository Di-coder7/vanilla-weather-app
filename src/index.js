  ...
  function displayWeatherCondition(response) {
    ...
    document.querySelector("#h1-icon").setAttribute(
        "src",
        `https://ssl.gstatic.com/onebox/weather/64/${response.data.condition.icon}.png`
      );
    document
  ...
  function searchLocation(position) {
    let apiKey = "d527df6aa83c9f534ae4562144311714";
    let apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${position.coords.longitude}&lat=${position.coords.latitude}&key=${apiKey}&units=metric`;
